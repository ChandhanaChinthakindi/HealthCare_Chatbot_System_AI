...
#conn = sqlite3.connect('C:/Users/Princy CKV/Desktop/chatbot/seminar2_progress/shrya/db/sqlite/db/pythonsqlite.db')
...
def matchingSentence(inp):
	...
	c = conn.cursor()
	f = open('C:/Users/Princy CKV/Desktop/chatbot/database/questions.txt')
	match = "";
	max_score=0;
